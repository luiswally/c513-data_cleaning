...
query0 = """
DROP TABLE IF EXISTS lowCostRestaurants_raw;
"""

query1 = """
CREATE TABLE lowCostRestaurants_raw AS
SELECT
    ...
    MenuItem.dish_id
FROM
    MenuItem_raw as MenuItem
    JOIN MenuPage_raw as MenuPage ON MenuItem.menu_page_id = MenuPage.id
    JOIN Menu_raw as Menu ON MenuPage.menu_id = Menu.id # ensures that a restaurant can be identified
